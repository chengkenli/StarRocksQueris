...
func SendFsCartOpenID2User(body []*util.Larkbodys) {
    ...
    "content": "%s"
		...
		SendFsText(filepath.Base(os.Args[0]), fmt.Sprintf("app:[%s] userid:[%s] username:[%s] connectionId:[%s] send feishu done.", app, userid, username, connectionId[1]), "", []string{"2717b942-0a19-4248-a495-f290380ae7b4"})
	}
